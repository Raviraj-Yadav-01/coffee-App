...
class $AssetsImagesGen {
  ...
  /// Directory path: assets/images/coffee_app
  $AssetsImagesCoffeeAppGen get coffeeApp => const $AssetsImagesCoffeeAppGen();
}

class $AssetsImagesCoffeeAppGen {
  const $AssetsImagesCoffeeAppGen();

  /// File path: assets/images/coffee_app/Coffee-bg.jpg
  AssetGenImage get coffeeBg =>
      const AssetGenImage('assets/images/coffee_app/Coffee-bg.jpg');

  /// File path: assets/images/coffee_app/coffee-bg-2.png
  AssetGenImage get coffeeBg2 =>
      const AssetGenImage('assets/images/coffee_app/coffee-bg-2.png');

  /// File path: assets/images/coffee_app/coffee1.png
  AssetGenImage get coffee1 =>
      const AssetGenImage('assets/images/coffee_app/coffee1.png');

  /// File path: assets/images/coffee_app/coffee2.png
  AssetGenImage get coffee2 =>
      const AssetGenImage('assets/images/coffee_app/coffee2.png');

  /// File path: assets/images/coffee_app/coffee3.png
  AssetGenImage get coffee3 =>
      const AssetGenImage('assets/images/coffee_app/coffee3.png');

  /// File path: assets/images/coffee_app/coffee4.png
  AssetGenImage get coffee4 =>
      const AssetGenImage('assets/images/coffee_app/coffee4.png');

  /// File path: assets/images/coffee_app/ice-coffee.png
  AssetGenImage get iceCoffee =>
      const AssetGenImage('assets/images/coffee_app/ice-coffee.png');

  /// File path: assets/images/coffee_app/product1.png
  AssetGenImage get product1 =>
      const AssetGenImage('assets/images/coffee_app/product1.png');

  /// File path: assets/images/coffee_app/product2.png
  AssetGenImage get product2 =>
      const AssetGenImage('assets/images/coffee_app/product2.png');

  /// File path: assets/images/coffee_app/product3.png
  AssetGenImage get product3 =>
      const AssetGenImage('assets/images/coffee_app/product3.png');

  /// File path: assets/images/coffee_app/product4.png
  AssetGenImage get product4 =>
      const AssetGenImage('assets/images/coffee_app/product4.png');

  /// File path: assets/images/coffee_app/product5.png
  AssetGenImage get product5 =>
      const AssetGenImage('assets/images/coffee_app/product5.png');

  /// File path: assets/images/coffee_app/product6.png
  AssetGenImage get product6 =>
      const AssetGenImage('assets/images/coffee_app/product6.png');

  /// File path: assets/images/coffee_app/profile-img.png
  AssetGenImage get profileImg =>
      const AssetGenImage('assets/images/coffee_app/progile_image.jpg');
